...
Card = function (point, group) {
    this.position = point;
    var cardImg = game.add.sprite(this.position.x, this.position.y, 'elementalBGs', 5, group);
    cardImg.anchor.setTo(0.5, 0.5);

    var buffer = 3;
    var frameImage = game.add.sprite(-cardImg.width / 2, -cardImg.height / 2, 'cardFrameSheet', 3)
    cardImg.anchor.setTo(0.5, 0.5);
